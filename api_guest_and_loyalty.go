...
type ApiGuestsGetRequest struct {
	ctx context.Context
...
func (r ApiGuestsGetRequest) Email(email string) ApiGuestsGetRequest {
	r.email = &email
	return r
}

func (r ApiGuestsGetRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.GuestsGetExecute(r)
}
...
The guests API returns the unique guest ID of a user based on the users email ID
 ...
 @return ApiGuestsGetRequest
*/
func (a *GuestAndLoyaltyApiService) GuestsGet(ctx context.Context) ApiGuestsGetRequest {
	return ApiGuestsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *GuestAndLoyaltyApiService) GuestsGetExecute(r ApiGuestsGetRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GuestAndLoyaltyApiService.GuestsGet")
	if err != nil {
